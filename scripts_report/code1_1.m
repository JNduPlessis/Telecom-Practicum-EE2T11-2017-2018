...
title('Initial step response','Fontsize',15); axis([0 N 0 1.2])
...
ylabel('H(t)','Fontsize',15); xlabel('Time Index','Fontsize',15); grid on;
title('Step response of filter H(t) with a = 0.95','Fontsize',15); axis([0 N 0 22])

subplot(212); stem(n,y_lp_impulse,'filled','LineStyle','-','LineWidth',0.8,'Color','black','Marker','^','MarkerSize',2);
ylabel('H(t)','Fontsize',15); xlabel('Time Index','Fontsize',15); grid on;
title('Impulse response of filter H(t) with a = 0.95','Fontsize',15); axis([0 N 0 1.2])

%High Pass Filter
figure(3)
subplot(211); stem(n,y_hp_step,'filled','LineStyle','-','LineWidth',0.8,'Color','black','Marker','^','MarkerSize',2);
ylabel('H(t)','Fontsize',15); xlabel('Time Index','Fontsize',15); grid on;
title('Step response of filter H(t) with a = -0.95','Fontsize',15); axis([0 N 0 1.2])

subplot(212); stem(n,y_hp_impulse,'filled','LineStyle','-','LineWidth',0.8,'Color','black','Marker','^','MarkerSize',2);
ylabel('H(t)','Fontsize',15); xlabel('Time Index','Fontsize',15); grid on;
title('Impulse response of filter H(t) with a = -0.95','Fontsize',15); axis([0 N -1.2 1.2])
